...
adicionarBotao("Combate", "Roubar Automático", function()
	...
	local itens = {
		...
		"Saco de lixo", "Peça de Arma", "Tratamento", "AR-15", "PS5", "C4", "USP", "Xbox", "Plástico Vazio", "Planta Limpa", "Planta Suja", "Plástico Pronto", "Presente Verde","Presente Vermelho", "Presente Azul"	
	}
...
UpdateStaffList()--==============================
-- TOGGLE MENU COM TECLA H
--==============================
local UserInputService = game:GetService("UserInputService")
local Players = game:GetService("Players")

local player = Players.LocalPlayer
local menuGui = game:GetService("CoreGui"):FindFirstChild("GrandMenu")

-- fallback caso esteja no PlayerGui
if not menuGui then
	menuGui = player:WaitForChild("PlayerGui"):FindFirstChild("GrandMenu")
end
...
UserInputService.InputBegan:Connect(function(input, gameProcessed)
	...
	if input.KeyCode == Enum.KeyCode.H then
		if menuGui and menuGui:FindFirstChild("Main") then
			menuAberto = not menuAberto
			menuGui.Main.Visible = menuAberto
		end
	end
end)
